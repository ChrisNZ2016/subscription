  ...
  return (
    <section className="ingredients-section" id="ingredients">
      <div className="ingredients-inner">
        ...
        <div className="ingredients-grid-wrapper">
          <div className="ingredient-grid">
            {ingredientCategories.map((cat) => (
              <div className="ingredient-card" key={cat.name}>
                <h3><span className="ing-dot">·</span> {cat.name}</h3>
                <p className="ingredient-why">{cat.why}</p>
                <p className="ingredient-what">{cat.what}</p>
              </div>
            ))}
          </div>
        </div>
